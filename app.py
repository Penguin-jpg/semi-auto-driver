...
def get_args():
    ...
    parser.add_argument(
        "--min_detection_confidence", help="min_detection_confidence", type=float, default=0.7
    )
...
def draw_info(image, fps, mode, number):
    ...
    cv.putText(
        image, "FPS:" + str(fps), (10, 30), cv.FONT_HERSHEY_SIMPLEX, 1.0, (255, 255, 255), 2, cv.LINE_AA
    )
